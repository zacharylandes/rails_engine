    ...
    namespace :api do
      namespace :v1 do
        ...
        namespace :merchants do
          ...
          get '/random' => "merchant_random#show"
        ...
        namespace :customers do
          ...
          get '/random' => "customer_random#show"
        end
        ...
        namespace :transactions do
          ...
          get '/random' => "transaction_random#show"
        end
        ...
        namespace :invoices do
          ...
          get '/random' => "invoice_random#show"
        end
        ...
        namespace :invoice_items do
          ...
          get '/random' => "invoice_item_random#show"
        end
